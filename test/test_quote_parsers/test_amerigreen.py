...
class TestAmerigreen(QuoteParserTest, TestCase):
    ...
    def test_first(self):
        ...
        self.assertEqual(datetime(2015, 9, 2), q.start_until)
        ...
        self.assertEqual(datetime(2015, 8, 3), q.valid_from)
        self.assertEqual(datetime(2015, 8, 4), q.valid_until)
        ...
        self.assertEqual(0.3403, q.price)
